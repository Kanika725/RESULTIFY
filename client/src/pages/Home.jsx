  ...
  return (
    <div
      ...
      style={{
        ...
        background: `linear-gradient(to right, rgba(0, 0, 0, 1), transparent), url('https://www.shutterstock.com/image-vector/school-building-front-view-green-260nw-2340208405.jpg')`,
